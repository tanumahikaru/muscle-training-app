...
public class UserDTO {
	...
	public UserDTO(int id, String name, String salt, String password, String hashedPassword, int gender, Date birth,
			float height, String mail, int level, int training_program_id, int food_id, Date last_login) {
		super();
		this.id = id;
		this.name = name;
		this.salt = salt;
